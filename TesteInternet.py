...
====================================================================
    ...
    printer('Provedor de internet                    : %(isp)s (%(ip)s)...' % speedtest.config['client'],
            quiet)
    ...
    if not args.mini:
        ...
        if args.server and len(args.server) == 1:
            ...
            printer('Selecionando o provedor de testes       : baseado na menor resposta de ping', quiet)
    ...
    printer('Servidor de teste                       : %(sponsor)s (%(name)s) [%(d)0.2f km]: '
